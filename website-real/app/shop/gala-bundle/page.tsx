...
export default function GalaBundlePage() {
  ...
  const { isOutOfStock, isSizeSoldOut } = useProductStock('8601b9a3-67c3-4820-8f74-2b975b1a95cf');
          ...
          {allFilled && (
            ...
            >
              <div className="max-w-4xl mx-auto">
                ...
                >
                  {isOutOfStock(null) ? 'OUT OF STOCK' : `Add to Cart • $${SHIRT_BUNDLE_PRICING.gala[bundleSize]}`}
                </button>
              </div>
            </motion.div>
          )}
