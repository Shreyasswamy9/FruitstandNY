...
export default function GalaBundlePage() {
  ...
  const { isOutOfStock, isSizeSoldOut } = useProductStock('a2faf1a9-461f-41b1-b6dd-8d3ec26b021c');
          ...
          {allFilled && (
            ...
            >
              <div className="max-w-4xl mx-auto">
                ...
                >
                  {isOutOfStock(null) ? 'OUT OF STOCK' : `Add to Cart • $${SHIRT_BUNDLE_PRICING.fuji[bundleSize]}`}
                </button>
              </div>
            </motion.div>
          )}
