...
export default function DenimHatPage() {
  const colorOptions = [
    { name: 'Blue', color: '#3B82F6', image: '/images/denimhatmale1.jpeg', bg: '#e6f0fa' },
    { name: 'Black', color: '#232323', image: '/images/denimhatsolo.jpeg', bg: '#eaeaea' },
    { name: 'White', color: '#fff', image: '/images/denimhatfemale1.jpeg', bg: '#f8f8f8', border: '#bbb' },
    { name: 'Red', color: '#ef4444', image: '/images/denimhatmale2.jpeg', bg: '#faeaea' },
  ];
  ...
  <div className="flex gap-3 mb-4 px-1" style={{ overflowX: 'auto', marginBottom: 24, paddingTop: 8, paddingBottom: 8, minHeight: 48 }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            ...
            <SizeGuide productSlug="denim-hat" className="mt-2" />
          </div>
        </div>
