...
export default function CameoTshirtPage() {
  ...
  const customerReviews = [
    { id: 1, name: 'Sam W.', rating: 5, review: 'Lovely colorways and super comfy.', date: '3 weeks ago' },
    { id: 2, name: 'Dana K.', rating: 4, review: 'Holds up well after washes.', date: '1 month ago' },
  ];
        ...
        <div className="md:w-1/2 flex flex-col justify-center">
          ...
          <div style={{ marginBottom: 18 }}>
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <SizeGuide productSlug="cameo-tshirt" className="mt-2" />
            </div>
          </div>
