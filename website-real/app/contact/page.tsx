...
const quickActions = [
  ...
  {
    title: "The Fruitstand loyalty program",
...
const socialLinks = [
  { icon: Instagram, label: "Instagram", href: "https://www.instagram.com/fruitstandny" },
  { icon: Twitter, label: "Twitter", href: "https://x.com/fruitstandny" },
  { icon: Youtube, label: "YouTube", href: "https://www.youtube.com/@fruitstandny" },
]
      ...
      <footer className="border-t border-[#181818]/10 bg-white/60 px-6 py-12 sm:px-10">
        <div className="mx-auto flex max-w-5xl flex-col gap-6 justify-between text-[#181818] sm:flex-row sm:items-center">
          <p className="text-[10px] uppercase tracking-[0.22em] text-[#6f6f6f]">
            FRUITSTAND® Customer Support · 2026
          </p>
