...
export const bundles: Bundle[] = [
  ...
  },
  {
    ...
    title: 'Broadway Blueberry Jersey + Porcelain Hat',
    // Jersey (1) + Porcelain Hat (3002)
    itemIds: [1, 3002],
    description: 'Statement Broadway Blueberry Jersey paired with the Porcelain Hat',
    discountPercent: 15,
  },
  {
    id: 'tracksuit-ecru-hat',
    title: 'Retro Track Suit + Ecru Hat',
    // Track Suit (2001) + Ecru Hat (3003)
    itemIds: [2001, 3003],
    description: 'Retro Track Suit comfort paired with the Ecru Hat',
    discountPercent: 12,
  },
];
