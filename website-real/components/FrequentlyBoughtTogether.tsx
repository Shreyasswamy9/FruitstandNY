...
const FBT_POOL: FBTProduct[] = [
  ...
  { id: 'forest-hills-hat', name: 'Forest Hills Hat', price: 46, image: '/images/products/Forest Hills Hat/Forest Hills Hat.png' },
  { id: 'porcelain-hat', name: 'Porcelain FS Cap', price: 44, image: '/images/products/Porcelain Hat/FS2.png' },
  { id: 'denim-hat', name: 'Indigo Hat', price: 44, image: '/images/products/denim-hat/D1.png' },
  { id: 'ecru-hat', name: 'Ecru Hat', price: 44, image: '/images/products/Ecru Hat/B1.png' },
  { id: 'empire-hat', name: 'Empire Corduroy Hat', price: 49, image: '/images/products/empire-hat/Empire Corduroy Hat.png' },
  ...
  { id: 'cameo-tshirt', name: 'Cameo Tee', price: 40, image: '/images/products/cameo-tshirt/broadwaynoir/Cameo Broadway Noir.png' },
