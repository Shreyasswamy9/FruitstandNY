...
export const products: Product[] = [
  ...
  // Kiwi Rugby Jersey
    { id: 2, name: "Kiwi Rugby Jersey", price: "$125", salePrice: 59.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/kiwi rugby jersey/Kiwi DS 1x1.png", hoverImage: "/images/products/kiwi rugby jersey/Kiwi 2.png", category: "Jerseys", variantSlug: "kiwi-rugby-jersey", badgeLabel: "NEW" },
  // Liberty Zip-Up
  { id: 3, name: "Liberty Zip-Up", price: "$110", salePrice: 64.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/liberty zip ups/copper/Copper DS 1x1.png", hoverImage: "/images/products/liberty zip ups/copper/Copper Zip 1.png", category: "Outerwear", variantSlug: "liberty-zip-up", badgeLabel: "NEW" },
  { id: 31, name: "Liberty Zip-Up", price: "$110", salePrice: 64.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/liberty zip ups/moss/Moss DS 1x1.png", hoverImage: "/images/products/liberty zip ups/moss/Moss Zip 1.png", category: "Outerwear", variantColor: "Moss", variantSlug: "moss", stPatsBadge: true, stPatsOriginalPrice: 110 },
  // Liberty Hoodie
  { id: 4, name: "Liberty Hoodie", price: "$110", salePrice: 64.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/liberty hoodies/mauve/Mauve DS 1x1.png", hoverImage: "/images/products/liberty hoodies/mauve/Mauve Hoodie 1 copy.png", category: "Outerwear", variantSlug: "liberty-hoodie", badgeLabel: "NEW" },
  // Jozi Rugby Jersey
  { id: 5, name: "Jozi Rugby Jersey", price: "$125", salePrice: 59.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/jozi rugby jersey/Jozi DS 1x1.png", hoverImage: "/images/products/jozi rugby jersey/Jozi 1.png", category: "Jerseys", variantSlug: "jozi-rugby-jersey", badgeLabel: "NEW", stPatsBadge: true, stPatsOriginalPrice: 125 },
  // Stamped Waffle Knit
  { id: 1081, name: "Stamped Waffle Knit", price: "$100", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/waffle knit/Waffle Knit DS 1x1.png", hoverImage: "/images/products/waffle knit/Stamped Waffle Knit 1.png", category: "Tops", variantSlug: "stamped-waffle-knit", badgeLabel: "NEW" },
  // Retro Track Suit Collection (spotlight second)
  { id: 2001, name: "Retro Track Suit", price: "$165", salePrice: 82.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/tracksuits/ELMHURST TARO CUSTARD/TP.png", hoverImage: "/images/products/tracksuits/ELMHURST TARO CUSTARD/TS7.png", category: "Tracksuits", variantColor: "Elmhurst Taro Custard", variantSlug: "elmhurst-taro-custard" },
  { id: 2002, name: "Retro Track Suit", price: "$165", salePrice: 82.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/tracksuits/Greenpoint Patina Crew/GB.png", hoverImage: "/images/products/tracksuits/Greenpoint Patina Crew/TS2.png", category: "Tracksuits", variantColor: "Greenpoint Patina Crew", variantSlug: "greenpoint-patina-crew", stPatsBadge: true, stPatsOriginalPrice: 165 },
  { id: 2003, name: "Retro Track Suit", price: "$165", salePrice: 82.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/tracksuits/NOHO NAPOLETANOS/TB.png", hoverImage: "/images/products/tracksuits/NOHO NAPOLETANOS/TS3.png", category: "Tracksuits", variantColor: "Noho Napoletanos", variantSlug: "noho-napoletanos" },
  { id: 2004, name: "Retro Track Suit", price: "$165", salePrice: 82.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/tracksuits/THE FACTORY FLOOR/BG.png", hoverImage: "/images/products/tracksuits/THE FACTORY FLOOR/TS4.png", category: "Tracksuits", variantColor: "The Factory Floor", variantSlug: "the-factory-floor" },
  { id: 2005, name: "Retro Track Suit", price: "$165", salePrice: 82.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/tracksuits/VICE CITY RUNNERS/PB.png", hoverImage: "/images/products/tracksuits/VICE CITY RUNNERS/TS5.png", category: "Tracksuits", variantColor: "Vice City Runners", variantSlug: "vice-city-runners" },
  ...
  // Bundle Section
  {
    ...
    price: "$29.99",
    displayPrice: "Bundle from $29.99",
    image: "/images/products/Teebundle/Bundle Photo.png",
    hoverImage: "/images/products/Teebundle/Bundle Photo.png",
    category: "Tops",
  ...
  },
  {
    ...
    price: "$34.99",
    displayPrice: "Bundle from $34.99",
    image: "/images/products/Teebundle/Mutsu + Cameo Bundle.png",
    hoverImage: "/images/products/Teebundle/Mutsu + Cameo Bundle.png",
    category: "Tops",
    variantColor: "Build your bundle",
    isBundle: true,
  ...
  },
  {
    ...
    image: "/images/products/Teebundle/Fuji Bundle.png",
    hoverImage: "/images/products/Teebundle/Fuji Bundle.png",
    category: "Tops",
    variantColor: "Build your bundle",
    isBundle: true,
  ...
  },
  {
    ...
    name: "Hat Bundle",
    price: "$24.99",
    displayPrice: "Bundle from $24.99",
    image: "/images/products/Forest Hills Hat/Forest Hills Hat.png",
    hoverImage: "/images/products/Forest Hills Hat/Forest Hills Hat Close Up.png",
    category: "Hats",
    variantColor: "Build your bundle",
    isBundle: true,
    bundleId: "hat-bundle",
  ...
  { id: 1011, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/broadwaynoir/Gala Broadway Noir1.png", hoverImage: "/images/products/gala-tshirt/broadwaynoir/GN4.png", category: "Tops", variantColor: "Broadway Noir", variantSlug: "broadway-noir" },
  { id: 1012, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/suttonplacesnow/Gala Sutton Place Snow1.png", hoverImage: "/images/products/gala-tshirt/suttonplacesnow/GN11.png", category: "Tops", variantColor: "Sutton Place Snow", variantSlug: "sutton-place-snow" },
  { id: 1013, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/Grasshopper/Gala Grasshopper1.png", hoverImage: "/images/products/gala-tshirt/Grasshopper/GN8.png", category: "Tops", variantColor: "Grasshopper", variantSlug: "grasshopper", stPatsBadge: true, stPatsOriginalPrice: 40 },
  { id: 1014, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/frostedlemonade/Gala Frosted Lemonade1.png", hoverImage: "/images/products/gala-tshirt/frostedlemonade/GN10.png", category: "Tops", variantColor: "Frosted Lemonade", variantSlug: "frosted-lemonade" },
  { id: 1015, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/italianice/Gala Italian Ice1.png", hoverImage: "/images/products/gala-tshirt/italianice/GN2.png", category: "Tops", variantColor: "Italian Ice", variantSlug: "italian-ice" },
  { id: 1016, name: "Portugal Lightweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/gala-tshirt/ruby red/gala ruby red 1.png", hoverImage: "/images/products/gala-tshirt/ruby red/GN7.png", category: "Tops", variantColor: "Ruby Red", variantSlug: "ruby-red" },
  // Cameo variants
  { id: 1021, name: "Portugal Heavyweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/cameo-tshirt/broadwaynoir/Cameo Broadway Noir.png", hoverImage: "/images/products/cameo-tshirt/broadwaynoir/MN3.png", category: "Tops", variantColor: "Broadway Noir", variantSlug: "broadway-noir" },
  { id: 1022, name: "Portugal Heavyweight Tee", price: "$40", salePrice: 29.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/cameo-tshirt/suttonplacesnow/Cameo Sutton Place Snow11.png", hoverImage: "/images/products/cameo-tshirt/suttonplacesnow/MN2.png", category: "Tops", variantColor: "Sutton Place Snow", variantSlug: "sutton-place-snow" },
  // Mutsu variants
  { id: 1031, name: "Portugal Pocket Tee", price: "$45", salePrice: 34.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/mutsu-tshirt/broadwaynoir/Mutsu Broadway Noir.png", hoverImage: "/images/products/mutsu-tshirt/broadwaynoir/N1.png", category: "Tops", variantColor: "Broadway Noir", variantSlug: "broadway-noir" },
  { id: 1032, name: "Portugal Pocket Tee", price: "$45", salePrice: 34.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/mutsu-tshirt/suttonplacesnow/Mutsu Sutton Place Snow11.png", hoverImage: "/images/products/mutsu-tshirt/suttonplacesnow/N4.png", category: "Tops", variantColor: "Sutton Place Snow", variantSlug: "sutton-place-snow" },
  // Fuji Long Sleeve variants (updated colors & images)
  { id: 1041, name: "Portugal Heavyweight Pocket Long Sleeve", price: "$80", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/fuji-tshirt/Arboretum/Fuji Arboretum.png", hoverImage: "/images/products/fuji-tshirt/Arboretum/F11.png", category: "Tops", variantColor: "Arboretum", variantSlug: "arboretum", stPatsBadge: true, stPatsOriginalPrice: 80 },
  { id: 1042, name: "Portugal Heavyweight Pocket Long Sleeve", price: "$80", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/fuji-tshirt/Hudson blue/Fuji Hudson Blue.png", hoverImage: "/images/products/fuji-tshirt/Hudson blue/F9.png", category: "Tops", variantColor: "Hudson Blue", variantSlug: "hudson-blue" },
  { id: 1043, name: "Portugal Heavyweight Pocket Long Sleeve", price: "$80", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/fuji-tshirt/Redbird/Fuji Redbird.png", hoverImage: "/images/products/fuji-tshirt/Redbird/F5.png", category: "Tops", variantColor: "Redbird", variantSlug: "redbird" },
  ...
  { id: 3002, name: "Porcelain FS Cap", price: "$44", salePrice: 24.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Porcelain Hat/Porcelain Cap.png", hoverImage: "/images/products/Porcelain Hat/Porcelain Back.png", category: "Hats", variantSlug: "porcelain-hat" },

  // Ecru FS Cap (Beige)
  { id: 3003, name: "Ecru FS Cap", price: "$44", salePrice: 24.99, salePriceEffectiveDate: "2026-03-21", image: "/images/products/Ecru Hat/Ecru Cap.png", hoverImage: "/images/products/Ecru Hat/Ecru Back.png", category: "Hats", variantSlug: "ecru-hat" },

  // Empire Corduroy Hat
  { id: 3004, name: "Empire Corduroy Hat", price: "$49", salePrice: 24.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/empire-hat/Empire Corduroy Hat.png", hoverImage: "/images/products/empire-hat/A2.png", category: "Hats" },

  // Indigo FS Cap (Denim)
  { id: 3005, name: "Indigo FS Cap", price: "$44", salePrice: 24.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/denim-hat/Indigo Cap.png", hoverImage: "/images/products/denim-hat/D1.png", category: "Hats" },
  ...
  { id: 5001, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/ELMHURST TARO CUSTARD/P6.png", hoverImage: "/images/products/tracksuits/ELMHURST TARO CUSTARD/TS7.png", category: "Tracksuits", variantColor: "Elmhurst Taro Custard", variantSlug: "elmhurst-taro-custard" },
  { id: 5002, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/Greenpoint Patina Crew/P4.png", hoverImage: "/images/products/tracksuits/Greenpoint Patina Crew/TS2.png", category: "Tracksuits", variantColor: "Greenpoint Patina Crew", variantSlug: "greenpoint-patina-crew", stPatsBadge: true, stPatsOriginalPrice: 90 },
  { id: 5003, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/NOHO NAPOLETANOS/P7.png", hoverImage: "/images/products/tracksuits/NOHO NAPOLETANOS/TS3.png", category: "Tracksuits", variantColor: "Noho Napoletanos", variantSlug: "noho-napoletanos" },
  { id: 5004, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/THE FACTORY FLOOR/P1.png", hoverImage: "/images/products/tracksuits/THE FACTORY FLOOR/TS4.png", category: "Tracksuits", variantColor: "The Factory Floor", variantSlug: "the-factory-floor" },
  { id: 5005, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/VICE CITY RUNNERS/P2.png", hoverImage: "/images/products/tracksuits/VICE CITY RUNNERS/TS5.png", category: "Tracksuits", variantColor: "Vice City Runners", variantSlug: "vice-city-runners" },
  { id: 5006, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/Victory Liberty Club/P3.png", hoverImage: "/images/products/tracksuits/Victory Liberty Club/TS6.png", category: "Tracksuits", variantColor: "Victory Liberty Club", variantSlug: "victory-liberty-club" },
  { id: 5007, name: "Retro Track Pants", price: "$90", salePrice: 44.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Pants/YORKVILLE BLACK AND WHITE COOKIES/P5.png", hoverImage: "/images/products/tracksuits/YORKVILLE BLACK AND WHITE COOKIES/TS1.png", category: "Tracksuits", variantColor: "Yorkville Black and White Cookies", variantSlug: "yorkville-black-and-white-cookies" },

  // Track Top (variants)
  { id: 6001, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/ELMHURST TARO CUSTARD/J6.png", hoverImage: "/images/products/tracksuits/ELMHURST TARO CUSTARD/TS7.png", category: "Tracksuits", variantColor: "Elmhurst Taro Custard", variantSlug: "elmhurst-taro-custard" },
  { id: 6002, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/Greenpoint Patina Crew/J1.png", hoverImage: "/images/products/tracksuits/Greenpoint Patina Crew/TS2.png", category: "Tracksuits", variantColor: "Greenpoint Patina Crew", variantSlug: "greenpoint-patina-crew", stPatsBadge: true, stPatsOriginalPrice: 110 },
  { id: 6003, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/NOHO NAPOLETANOS/J7.png", hoverImage: "/images/products/tracksuits/NOHO NAPOLETANOS/TS3.png", category: "Tracksuits", variantColor: "Noho Napoletanos", variantSlug: "noho-napoletanos" },
  { id: 6004, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/THE FACTORY FLOOR/J4.png", hoverImage: "/images/products/tracksuits/THE FACTORY FLOOR/TS4.png", category: "Tracksuits", variantColor: "The Factory Floor", variantSlug: "the-factory-floor" },
  { id: 6005, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/VICE CITY RUNNERS/J3.png", hoverImage: "/images/products/tracksuits/VICE CITY RUNNERS/TS5.png", category: "Tracksuits", variantColor: "Vice City Runners", variantSlug: "vice-city-runners" },
  { id: 6006, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/Victory Liberty Club/J2.png", hoverImage: "/images/products/tracksuits/Victory Liberty Club/TS6.png", category: "Tracksuits", variantColor: "Victory Liberty Club", variantSlug: "victory-liberty-club" },
  { id: 6007, name: "Retro Track Jacket", price: "$110", salePrice: 49.99, salePriceEffectiveDate: "2026-03-26", image: "/images/products/Track Top/YORKVILLE BLACK AND WHITE COOKIES/J5.png", hoverImage: "/images/products/tracksuits/YORKVILLE BLACK AND WHITE COOKIES/TS1.png", category: "Tracksuits", variantColor: "Yorkville Black and White Cookies", variantSlug: "yorkville-black-and-white-cookies" },
];
